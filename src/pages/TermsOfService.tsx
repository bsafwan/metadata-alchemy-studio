            ...
            <div className="space-y-8 text-muted-foreground">
              <div className="scroll-reveal">
                ...
                <div className="bg-slate-50 p-4 rounded-md mt-4 flex items-start gap-3">
                  ...
                  <p className="text-sm">By continuing to access or use our services after any revisions to these Terms become effective, you agree to be bound by the revised terms. If you do not agree to the revised terms, you must stop using our services.</p>
                </div>
              </div>
              ...
              <div className="scroll-reveal">
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    <p>Some of our services require payment of fees on a subscription basis. By subscribing to a service, you agree to pay the applicable fees as they become due.</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  <div className="bg-slate-50 p-4 rounded-md">
                    ...
                    <p className="text-sm">Billed monthly with auto-renewal. You can cancel at any time before the next billing cycle.</p>
                  </div>
                  <div className="bg-slate-50 p-4 rounded-md">
                    <h3 className="font-semibold mb-2">Annual Subscription</h3>
                    <p className="text-sm">Billed annually with a discount compared to monthly billing. Auto-renews after 12 months.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="scroll-reveal">
                <h2 className="text-2xl font-bold text-foreground mb-4">Service Uptime and Maintenance</h2>
                <div className="flex items-start gap-3 mb-4">
                  <Clock className="text-elismet-blue mt-1 flex-shrink-0" />
                  <div>
                    <p>We strive to maintain the highest level of service availability. However, we may need to perform scheduled maintenance to ensure optimal performance of our services. We will make reasonable efforts to notify you in advance of any scheduled maintenance.</p>
                  </div>
                </div>
